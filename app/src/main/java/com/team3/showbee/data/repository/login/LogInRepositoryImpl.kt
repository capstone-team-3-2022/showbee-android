...
import com.team3.showbee.data.entity.LoginResponse
...
class LogInRepositoryImpl @Inject constructor(
    ...
    override suspend fun signIn(email: String, password: String): NetworkResponse<LoginResponse, ErrorResponse> {
